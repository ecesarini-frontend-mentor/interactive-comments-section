export class BuildSession {
    ...
    buildReplyByComment(comment) { // build reply container taking advantage of buildComment function;
        const commentRepliesGrid = document.createElement('div'),
            commentRepliesLine = document.createElement('div');
        ...
        commentRepliesGrid.append(commentRepliesLine);
        return commentRepliesGrid.append(comment);
    }
